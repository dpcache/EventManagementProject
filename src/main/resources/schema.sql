...
CREATE TABLE "REGISTRATIONS" ("ID" INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), "EVENTID" VARCHAR(255) NOT NULL, "REGISTRATIONDATE" VARCHAR(255) NOT NULL, "NOTES" VARCHAR(255) NOT NULL);
